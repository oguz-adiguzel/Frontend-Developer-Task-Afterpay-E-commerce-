        ...
        <div className="container flex justify-center">
            <div className="w-full md:w-1/2 h-96 bg-afterpay-orange mt-16 flex justify-center flex-col items-center">
                ...
                <form className="flex flex-col">
                    <label htmlFor="userName" className="text-white text-xl">E-mail</label>
                    <input value={email} onChange={(e) => dispatch(handleChangeUser(e))} id="userName" type='text' placeholder="E-mail Giriniz" className="w-64 h-9 pl-2 rounded-md" />
